  ...
  <div class="container">
    ...
    <div id="contact" class="collapse show">
      ...
      <div class="card card-body py-5">
        ...
        <h3 style="background-color: green; opacity: 0.3;">Thanks, I will be in touch soon</h3>
  ...
  <div class="container">
    ...
    <div id="contact" class="collapse show">
      ...
      <div class="card card-body py-5">
				...
				<h5 class="text-center" style="background-color: red; opacity: 0.3;">Looks like something went wrong. Please try again</h5>
